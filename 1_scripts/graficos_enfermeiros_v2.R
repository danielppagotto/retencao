...
ranking_10maiores <- Enfermeiros_dfs_geral |> 
...
medianas_regiao <- Enfermeiros_dfs_geral %>%
...
ggsave(grafico_regiao, filename = "retencao_boxplot_enfermeiros_regiao.svg",
...
mean(Enfermeiros_dfs_geral$retencao_geral[Enfermeiros_dfs_geral$uf != "Distrito Federal"])
...
median(Enfermeiros_dfs_geral$retencao_geral[Enfermeiros_dfs_geral$uf != "Distrito Federal"])
...
ggsave(grafico_uf, filename = "retencao_boxplot_enfermeiros_uf.svg",
...
ggsave(grafico_razao, filename = "correlacao_enfermeiros.svg",
...
Enfermeiros_dfs_geral$cod_regiao_saude <- as.integer(Enfermeiros_dfs_geral$cod_regiao_saude)
...
# Criar o mapa
mapa <- spdf_fortified |>
  left_join(Enfermeiros_dfs_geral, by = c("reg_id" = "cod_regiao_saude")) |>
...
ggsave(mapa, filename = "retencao_mapa_enfermeiros.svg",
       width = 3000, height = 2500, units = "px", dpi = 300)
