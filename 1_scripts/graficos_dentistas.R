...
ggsave(grafico_regiao, filename = "retencao_boxplot_dentistas_regiao.svg",
...
median(Dentistas_dfs_geral$retencao_geral[Dentistas_dfs_geral$uf != "Distrito Federal"])
...
ggsave(grafico_uf, filename = "retencao_boxplot_dentistas_uf.svg",
...
ggsave(grafico_razao, filename = "correlacao_dentistas.svg",
...
ggsave(mapa, filename = "retencao_mapa_dentistas.svg",
       width = 3000, height = 2500, units = "px", dpi = 300)
